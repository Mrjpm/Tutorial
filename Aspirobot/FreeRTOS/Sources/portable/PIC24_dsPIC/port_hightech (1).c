...
#define portRESTORE_CONTEXT() asm("    MOV	_pxCurrentTCB, W0      ");  \
							  asm("    MOV	[W0], W15			   ");  \
	                          asm("    POP	W0					   ");  \
	                          asm("    MOV	W0, _uxCriticalNesting ");  \
	                          asm("    POP	PSVPAG				   ");  \
	                          asm("    POP	CORCON				   ");  \
	                          asm("    POP	DOENDH				   ");  \
	                          asm("    POP	DOENDL				   ");  \
...
const StackType_t xInitialStack[] =
{
    ...
    #warning dsPIC specific registers
		0x0202, /* ACCAL */
		0x0303, /* ACCAH */
		0x0404, /* ACCAU */
		0x0505, /* ACCBL */
...
void interrupt _T1Interrupt( void ) @ T1_VCTR
{
